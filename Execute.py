...
#Execute SVD
SVD1 = hm.SVD('sn1up') #The type (buildtype) of svd you want to do
SVD1.BuildData() #Build data matrix based on buildtype
SVD1.ComputeSVD() #Compute the SVD

SVD2 = hm.SVD('sn1dn') #The type (buildtype) of svd you want to do
SVD2.BuildData() #Build data matrix based on buildtype
SVD2.ComputeSVD() #Compute the SVD

SVD3 = hm.SVD('sn2up') #The type (buildtype) of svd you want to do
SVD3.BuildData() #Build data matrix based on buildtype
SVD3.ComputeSVD() #Compute the SVD

SVD4 = hm.SVD('sn2dn') #The type (buildtype) of svd you want to do
SVD4.BuildData() #Build data matrix based on buildtype
SVD4.ComputeSVD() #Compute the SVD

SVD5 = hm.SVD('redux') #The type (buildtype) of svd you want to do
SVD5.BuildData() #Build data matrix based on buildtype
SVD5.ComputeSVD() #Compute the SVD
...
SVD1.MakePlots() #Plot all the results in one graph

SVD2.MakePlots() #Plot all the results in one graph

SVD3.MakePlots() #Plot all the results in one graph

SVD4.MakePlots() #Plot all the results in one graph

SVD5.MakePlots() #Plot all the results in one graph
